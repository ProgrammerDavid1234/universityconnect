...
import { Bell, Search, ChevronDown, Shield, Menu } from 'lucide-react';
            ...
            <div className={styles.mainContent}>
                <header className="h-20 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-40 gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-xl lg:text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent truncate">
                            {getPageTitle()}
                        </h2>
                    </div>
                    ...
                    <div className="flex items-center gap-2 lg:gap-6">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="hidden md:flex bg-red-50 text-red-700 text-xs font-bold px-4 py-2 rounded-full border border-red-100 shadow-sm items-center gap-2">
                            ...
                            <div className="flex items-center gap-3 pl-2 cursor-pointer group">
                                <div className="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-red-500 to-rose-600 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-md ring-2 ring-white group-hover:ring-red-100 transition-all">
                                    AD
                                </div>
