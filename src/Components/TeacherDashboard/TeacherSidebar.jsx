...
const TeacherSidebar = () => {
    const navItems = [
        ...
        { icon: BookOpen, label: 'Courses', path: '/teacher-dashboard/courses' },
        { icon: FileText, label: 'Assignments', path: '/teacher-dashboard/assignments' },
        { icon: GraduationCap, label: 'Enrollments', path: '/teacher-dashboard/enrollments' },
        { icon: Upload, label: 'Submissions', path: '/teacher-dashboard/submissions' },
    ];
